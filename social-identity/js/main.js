(() => {
  ...
  // ---------------------------------------------------------------------
  const MAKE_WEBHOOK_URL = "https://hook.us2.make.com/w7kibcy1dbj02fi2d2526o3bvn70825b";
  ...
  function initContactForm() {
    ...
    form.addEventListener("submit", async (e) => {
      ...
      const instagramField = document.getElementById("field-instagram");
      const payload = {
        name: fields.name.value.trim(),
        phone: fields.phone.value.trim(),
        business: businessField ? businessField.value.trim() : "",
        social: instagramField ? instagramField.value.trim() : "",
      };
