(() => {
  ...
  // ---------------------------------------------------------------------
  const MAKE_WEBHOOK_URL = "https://hook.us2.make.com/77on3hn6d2e9dwtfd97dof46f7xqnjjq";
  ...
  function initContactForm() {
    ...
    form.addEventListener("submit", async (e) => {
      ...
      const contentTypeField = document.getElementById("field-content-type");
      const detailsField = document.getElementById("field-details");
      const payload = {
        name: fields.name.value.trim(),
        phone: fields.phone.value.trim(),
        business: businessField ? businessField.value.trim() : "",
        type: contentTypeField ? contentTypeField.value : "",
      ...
      try {
        ...
        whatsappFallback.href = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
          `Hola! Soy ${fields.name.value.trim()}, me interesan sus servicios de contenido para redes.`
        )}`;
      }
    });
  }
